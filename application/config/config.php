...
|
*/
$config['index_page'] = ''; // (my_quote)we have to remove index.php which is by default written here
...
*/
$config['uri_protocol']	= 'REQUEST_URI'; // (my_quote)we have to write  REQUEST_URI if it is not written here
